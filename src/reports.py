...
def get_criteria_params(dbo, customreportid, post):
    ...
    for name, rtype, question in crit:
        ...
        if rtype == "DATE":
            p.append( ( name , question, dbo.sql_date(i18n.display2python(l, post[name]), includeTime=False, wrapParens=False), post[name]) )  
        elif rtype == "STRING":
            ...
            for a in post[name].split(","):
                animals.append(animal.get_animal_namecode(dbo, a))
            p.append( ( name, i18n._("Animals", l), post[name], ", ".join(animals) ))
            ...
            p.append( ( name, i18n._("Log Type", l), post[name], lookups.get_logtype_name(dbo, post.integer(name) )) )
        elif rtype == "TYPE":
