...
def animal_tags(dbo, a):
    ...
    tags = { 
        ...
        "PICKUPLOCATIONNAME"    : utils.nulltostr(a["PICKUPLOCATIONNAME"]),
        "PICKUPADDRESS"         : utils.nulltostr(a["PICKUPADDRESS"]),
        ...
        "ANIMALFLAGS"           : a["ADDITIONALFLAGS"].replace("|", ", "),
...
def animalcontrol_tags(dbo, ac):
    ...
    tags = {
        ...
        "SUSPECTHOMETELEPHONE": utils.nulltostr(ac["SUSPECTHOMETELEPHONE"]),
        "SUSPECTWORKTELEPHONE": utils.nulltostr(ac["SUSPECTWORKTELEPHONE"]),
        "SUSPECTMOBILETELEPHONE": utils.nulltostr(ac["SUSPECTMOBILETELEPHONE"]),
...
def person_tags(dbo, p):
    ...
    tags = { 
        ...
        "COMMENTS"              : p["COMMENTS"],
        "OWNERFLAGS"            : p["ADDITIONALFLAGS"].replace("|", ", "),
