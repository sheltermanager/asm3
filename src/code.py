...
class media(ASMEndpoint):
    ...
    def post_emailsign(self, o):
        ...
        utils.send_email(dbo, post["from"], emailadd, post["cc"], post["bcc"], _("Document signing request", l), "\n".join(body), "html")
        return emailadd
...
class publish_options(JSONEndpoint):
    ...
    def controller(self, o):
        ...
        c = {
            ...
            "hassaveourlife": SAVEOURLIFE_URL != "",
            "logtypes": extlookups.get_log_types(dbo),
