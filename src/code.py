    ...
    def content(self, o):
        ...
        # Sheltermanager.com
            ...
            if dbo.database == "WRONGSERVER":
                self.redirect(SMCOM_LOGIN_LINK)
        ...
        c = { "smcom": smcom.active(),
             ...
             "smcomloginlink": SMCOM_LOGIN_LINK,
