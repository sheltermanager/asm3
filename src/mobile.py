...
def handler_viewanimal(session, l, dbo, a, af, diet, vacc, test, med, logs, homelink, post):
    ...
    h.append(table())
    h.append("<tr><td><img src='%s' class='asm-thumbnail' /></td>" % html.thumbnail_img_src(dbo, a, "animalthumb"))
...
def handler_viewperson(session, l, dbo, p, af, cit, dia, lic, links, logs, homelink, post):
    ...
    h.append(table())
    h.append("<tr><td><img src='%s' class='asm-thumbnail' /></td>" % html.thumbnail_img_src(dbo, p, "personthumb"))
