...
def handler_addincident(l, homelink, dbo):
    ...
    h.append(jqm_fieldcontain("dispatchtown", _("Town", l), jqm_text("dispatchtown")))
    h.append(jqm_fieldcontain("dispatchcounty", _("County", l), jqm_text("dispatchcounty")))
...
def handler_viewincident(l, dbo, a, cit, dia, logs, homelink, post):
    ...
    h.append(tr( _("Town", l), a["DISPATCHTOWN"]))
    h.append(tr( _("County", l), a["DISPATCHCOUNTY"]))
    h.append(tr( _("Postcode", l), a["DISPATCHPOSTCODE"]))
