...
def update_person_from_form(dbo: Database, post: PostedData, username: str, geocode: bool = True) -> None:
    ...
    dbo.update("owner", pid, {
        ...
        "MatchAgeFrom":     post.floating("matchagedfrom"),
        "MatchAgeTo":       post.floating("matchagedto"),
