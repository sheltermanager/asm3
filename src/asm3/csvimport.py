...
VALID_FIELDS = [
    ...
    "ANIMALCODE", "ANIMALENTRYTYPE", "ANIMALNAME", "ANIMALSEX", "ANIMALTYPE", "ANIMALCOLOR", "ANIMALBREED1", "ANIMALBREED2", "ANIMALDOB", 
        ...
        if hasperson:
            if gks(row, "PERSONLASTNAME") != "" or gks(row, "PERSONNAME") != "":
                ...
                if p["matchactive"] == "1":
                    ...
                    if "PERSONMATCHDECLAWED" in cols: p["matchdeclawed"] = gkynu(row, "PERSONMATCHDECLAWED")
...
def csvexport_animals(dbo: Database, dataset: str, animalids: str = "", where: str = "", includemedia: str = "photo") -> str:
    ...
    keys = [
        "ANIMALID", "ANIMALCODE", "ANIMALENTRYTYPE", "ANIMALLITTER", "ANIMALNAME", "ANIMALSEX", "ANIMALTYPE", "ANIMALWEIGHT", "ANIMALCOLOR", "ANIMALBREED1",
...
def csvexport_people(dbo: Database, dataset: str, flags: str = "", where: str = "", includemedia: str = "photo") -> str:
    ...
    for pid in pids:
        ...
        row["PERSONMATCHDECLAWED"] = asm3.utils.cint(p["MATCHDECLAWED"])
