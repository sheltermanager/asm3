...
def menu_structure(l: str, publisherlist: Dict, reports: MenuItems, mailmerges: MenuItems, internalforms: MenuItems) -> MenuStructure:
    ...
    return (
        ("", "asm", _("ASM", l), (
            ...
            ( asm3.users.VIEW_ANIMAL, "", "", "map_view?mk=n", "asm-icon-map", _("Map of recent non-shelter animals", l) ),
            ( asm3.users.VIEW_ANIMAL, "", "", "map_view?mk=r", "asm-icon-blank", _("Map of recent reclaimed animals", l) ),
            ...
            ( asm3.users.VIEW_INCIDENT, "", "taganimalcontrol", "map_view?mk=a", "asm-icon-map", _("Map of active incidents", l) ),
            ( asm3.users.VIEW_INCIDENT, "", "taganimalcontrol", "map_view?mk=i", "asm-icon-blank", _("Map of recent incidents", l) ),
