...
def menu_structure(l: str, publisherlist: Dict, reports: MenuItems, mailmerges: MenuItems, internalforms: MenuItems) -> MenuStructure:
    ...
    return (
        ...
        (asm3.users.VIEW_MOVEMENT, "move", _("Move", l), (
            ...
            ( asm3.users.ADD_MOVEMENT, "", "", "move_reserve", "asm-icon-reservation", _("Reserve animal(s)", l) ),
            ( asm3.users.ADD_MOVEMENT, "alt+shift+o", "", "move_foster", "asm-icon-blank", _("Foster animal(s)", l) ),
            ( asm3.users.ADD_MOVEMENT, "", "", "move_transfer", "asm-icon-blank", _("Transfer animal(s)", l) ),
            ( asm3.users.ADD_MOVEMENT, "alt+shift+a", "", "move_adopt", "asm-icon-person", _("Adopt animal(s)", l) ),
            ( asm3.users.ADD_MOVEMENT, "", "", "move_reclaim", "asm-icon-blank", _("Reclaim animal(s)", l) ),
            ( asm3.users.ADD_MOVEMENT, "", "tagretailer", "move_retailer", "asm-icon-blank", _("Move animal(s) to a retailer", l) ),
