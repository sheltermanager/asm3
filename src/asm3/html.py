...
def menu_structure(l, publisherlist, reports, mailmerges):
    ...
    return (
        ("", "asm", _("ASM", l), (
            ...
            (asm3.users.ADD_EVENT, "alt+shift+e", "addevent", "event_new", "asm-icon-blank", _("Add event", l)),
            (asm3.users.VIEW_EVENT, "", "viewevent", "event_find", "asm-icon-blank", _("Find event", l)),
            ( "", "", "", "--break", "", "" ),
