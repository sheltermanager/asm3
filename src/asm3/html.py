...
def menu_structure(l, publisherlist, reports, mailmerges):
    ...
    return (
        ("", "asm", _("ASM", l), (
            ...
            ("", "", "event", "--cat", "asm-icon-calendar", _("Event", l)),
            (asm3.users.ADD_EVENT, "alt+shift+e", "addevent", "event_new", "asm-icon-event-add", _("Add event", l)),
            (asm3.users.VIEW_EVENT, "", "viewevent", "event_find", "asm-icon-event-find", _("Find event", l)),
            ( "", "", "", "--break", "", "" ),
