...
def org_tags(dbo: Database, username: str) -> Tags:
    ...
    tags = {
        ...
        "SIGNATUREDATE"         : '{SIGNING_DATE}',
        "SIGNATUREIP"           : '{SIGNING_IP}',
        "SIGNATUREUA"           : '{SIGNING_UA}',
        "DATABASE"              : dbo.name(),
        "USERNAME"              : username,
...
def animal_tags(dbo: Database, a: ResultRow, includeAdditional=True, includeCosts=True, includeDiary=True, 
    ...
    tags = { 
        ...
        "CRATETRAINED"          : a["ISCRATETRAINEDNAME"],
        "GOODWITHELDERLY"       : a["ISGOODWITHELDERLYNAME"],
        "GOODTRAVELLER"         : a["ISGOODTRAVELLERNAME"],
        "GOODONLEAD"            : a["ISGOODONLEADNAME"],
        ...
        "BROUGHTINBYIDNUMBER"   : a["BROUGHTINBYIDNUMBER"],
    ...
    if includeMedical:
        ...
        d = {
            ...
            "VACCINATIONBATCHEXPIRY":   "d:BATCHEXPIRYDATE",
        ...
        tags["ANIMALVACCINATIONS"] = html_table(l, vaccinations, (
            ...
            ( "BATCHEXPIRYDATE", _("Batch Expiry", l)),
...
def movement_tags(dbo: Database, m: ResultRow) -> Tags:
    ...
    tags = {
        ...
        "RETURNEDBYIDNUMBER":           m["RETURNEDBYIDNUMBER"],
...
def voucher_tags(dbo: Database, v: ResultRow) -> Tags:
    ...
    tags = {
        ...
        "VOUCHERVETADDRESS": v["VETADDRESS"],
        "VOUCHERVETTOWN": v["VETTOWN"],
        "VOUCHERVETCITY": v["VETTOWN"],
        "VOUCHERVETCOUNTY": v["VETCOUNTY"],
        "VOUCHERVETSTATE": v["VETCOUNTY"],
        "VOUCHERVETPOSTCODE": v["VETPOSTCODE"],
        "VOUCHERVETZIPCODE": v["VETPOSTCODE"],
        "VOUCHERVETPHONE": v["VETTELEPHONE"],
        "VOUCHERVETEMAILADDRESS": v["VETEMAILADDRESS"],
