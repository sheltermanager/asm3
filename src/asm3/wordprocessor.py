...
def additional_field_person_tags(dbo, p, prefix, fieldname, depth):
    ...
    tags = {
        ...
        prefix + fieldname + "DATEOFBIRTH":     python2display(l, p["DATEOFBIRTH"]),
        prefix + fieldname + "DATEOFBIRTH2":    python2display(l, p["DATEOFBIRTH2"]),
...
def person_tags(dbo, p, includeImg=False, includeDonations=False, includeVouchers=False):
    ...
    tags = { 
        ...
        "DATEOFBIRTH"           : python2display(l, p["DATEOFBIRTH"]),
        "DATEOFBIRTH2"          : python2display(l, p["DATEOFBIRTH2"]),
