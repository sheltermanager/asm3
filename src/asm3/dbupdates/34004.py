...
execute(dbo,sql)
execute(dbo,"INSERT INTO transporttype VALUES (1, ?, '', 0)", [ _("Adoption Event", l) ])
execute(dbo,"INSERT INTO transporttype VALUES (2, ?, '', 0)", [ _("Foster Transfer", l) ])
execute(dbo,"INSERT INTO transporttype VALUES (3, ?, '', 0)", [ _("Surrender Pickup", l) ])
execute(dbo,"INSERT INTO transporttype VALUES (4, ?, '', 0)", [ _("Vet Visit", l) ])
