...
dbo.execute("INSERT INTO lkadoptionsource (ID, SourceName, Description, IsRetired) VALUES (?, ?, ?, ?)", [2, _("Social Media"), "", 0] )
dbo.execute("INSERT INTO lkadoptionsource (ID, SourceName, Description, IsRetired) VALUES (?, ?, ?, ?)", [3, _("Newspaper"), "", 0] )
dbo.execute("INSERT INTO lkadoptionsource (ID, SourceName, Description, IsRetired) VALUES (?, ?, ?, ?)", [4, _("PetFinder.com"), "", 0] )
