...
execute(dbo,"INSERT INTO lksmediatype (ID, MediaType) VALUES (?, ?)", [ 0, _("File", l) ])
execute(dbo,"INSERT INTO lksmediatype (ID, MediaType) VALUES (?, ?)", [ 1, _("Document Link", l) ])
execute(dbo,"INSERT INTO lksmediatype (ID, MediaType) VALUES (?, ?)", [ 2, _("Video Link", l) ])
