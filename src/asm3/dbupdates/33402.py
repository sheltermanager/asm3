...
execute(dbo,"INSERT INTO stockusagetype VALUES (1, '%s', '')" % _("Administered", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (2, '%s', '')" % _("Consumed", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (3, '%s', '')" % _("Donated", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (4, '%s', '')" % _("Purchased", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (5, '%s', '')" % _("Sold", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (6, '%s', '')" % _("Stocktake", l))
execute(dbo,"INSERT INTO stockusagetype VALUES (7, '%s', '')" % _("Wasted", l))
