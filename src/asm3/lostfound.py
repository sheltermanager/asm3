...
def send_email_from_form(dbo: Database, username: str, post: PostedData) -> bool:
    ...
    if addtolog == 1:
        asm3.log.add_log_email(dbo, username, post["lfmode"] == "lost" and asm3.log.LOSTANIMAL or asm3.log.FOUNDANIMAL, post.integer("lfid"), logtype, emailto, emailcc, emailbcc, subject, body)
    return rv
