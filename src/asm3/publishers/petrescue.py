...
class PetRescuePublisher(AbstractPublisher):
    ...
    def processAnimal(self, an, all_desexed=False, adoptable_in="", suburb="", state="", postcode="", contact_name="", contact_number="", contact_email="", all_microchips=False):
        ...
        return {
            ...
            "incompatible_with_kids_under_5": an.ISGOODWITHCHILDREN == 1 || an.ISGOODWITHCHILDREN >= 5,
            "incompatible_with_kids_6_to_12": an.ISGOODWITHCHILDREN == 1 || an.ISGOODWITHCHILDREN == 12,
