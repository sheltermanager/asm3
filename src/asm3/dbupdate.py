...
def sql_structure(dbo: Database) -> str:
    ...
    sql += table("lkclinicinvoiceitems", (
        fid(),
        fstr("ClinicInvoiceItemName"),
        fstr("ClinicInvoiceItemDescription", True),
        fint("DefaultCost", True),
        fint("IsRetired", True) ), False)
    ...
    sql += table("onlineformfield", (
        ...
        fint("ValidationRule", True)), False)
...
def sql_default_data(dbo: Database, skip_config: bool = False) -> str:
    ...
    sql += lookup2("adoptionsource", "SourceName", 1, _("AdoptAPet.com", l))
    sql += lookup2("adoptionsource", "SourceName", 2, _("Meta", l))
    sql += lookup2("adoptionsource", "SourceName", 3, _("Newspaper", l))
    sql += lookup2("adoptionsource", "SourceName", 4, _("PetFinder", l))
    sql += lookup2("adoptionsource", "SourceName", 5, _("Word of Mouth", l))
    ...
    sql += lookup1("lksfieldlink", "LinkType", 31, _("Person - Couple", l))
