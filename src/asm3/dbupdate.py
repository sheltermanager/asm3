...
def dump_merge(dbo, deleteViewSeq = True):
    ...
    yield fix_and_dump("animal", [ "ID", "AnimalTypeID", "ShelterLocation", "ShelterCode", "BondedAnimalID", "BondedAnimal2ID", "OwnersVetID", "CurrentVetID", "OriginalOwnerID", "BroughtInByOwnerID", "ActiveMovementID" ])
    yield fix_and_dump("animalcontrol", [ "ID", "CallerID", "VictimID", "OwnerID", "Owner2ID", "Owner3ID" ])
    ...
    yield fix_and_dump("animalfound", [ "ID", "OwnerID" ])
    yield fix_and_dump("animallitter", [ "ID", "ParentAnimalID" ])
    yield fix_and_dump("animallost", [ "ID", "OwnerID" ])
    ...
    yield fix_and_dump("owner", [ "ID", "HomeCheckedBy" ])
