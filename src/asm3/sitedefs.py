...
# If a queue folder is specified, then when a PUT is done, files are not immediately 
# uploaded to S3. Instead, files are saved here for upload by a separate process
DBFS_S3_QUEUE_FOLDER = get_string("dbfs_s3_queue_folder", "")
