...
TABLESORTER_CSS = get_string("tablesorter_css", 'static/lib/tablesorter/2.31.3/dist/css/theme.asm.css')
TABLESORTER_JS = get_string("tablesorter_js", 'static/lib/tablesorter/2.31.3/dist/js/jquery.tablesorter.min.js')
TABLESORTER_WIDGETS_JS = get_string("tablesorter_widgets_js", 'static/lib/tablesorter/2.31.3/dist/js/jquery.tablesorter.widgets.min.js')
