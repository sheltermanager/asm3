...
FINDPET_BASE_URL = get_string("findpet_base_url", "")
FINDPET_API_KEY = get_string("findpet_api_key", "")
...
MYPET_BASE_URL = get_string("mypet_base_url", "")
MYPET_API_USER = get_string("mypet_api_user", "")
MYPET_API_KEY = get_string("mypet_api_key", "")
...
SMARTTAG_HOST = get_string("smarttag_host", "")
...
AVID_US_API_KEY = get_string("avid_us_api_key", "")
...
LEAFLET_CSS = get_string("leaflet_css", 'static/lib/leaflet/1.9.4/leaflet.css')
LEAFLET_JS = get_string("leaflet_js", 'static/lib/leaflet/1.9.4/leaflet.js')
