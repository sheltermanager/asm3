...
SMARTTAG_HOST = get_string("smarttag_host", "https://wordpress-1352309-4971911.cloudwaysapps.com/wp-json/pet-api/v1/pets")# To do - switch form dev to live when testing completed - Adam.
SMARTTAG_API_KEY = get_string("smarttag_api_key", "https://wordpress-1352309-4971911.cloudwaysapps.com/wp-json/pet-api/v1")
