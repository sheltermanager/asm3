...
SMARTTAG_HOST = get_string("smarttag_host", "https://wordpress-1352309-5534339.cloudwaysapps.com/wp-json/pet-api/v1/pets")# To do - switch from dev to live when testing completed - Adam.
SMARTTAG_API_KEY = get_string("smarttag_api_key", "70e2ab33-b237-4a1d-9b5d-7ff9aabee9a2")
