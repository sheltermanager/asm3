...
SMARTTAG_HOST = get_string("smarttag_host", "https://wordpress-1352309-4971911.cloudwaysapps.com/wp-json/pet-api/v1")# To do - switch form dev to live when testing completed - Adam.
SMARTTAG_API_KEY = get_string("smarttag_api_key", "xxxx-xxxx-xxxx")
