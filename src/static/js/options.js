    ...
    const options = {
        ...
        render_logs: function() {
            return [
                '<div id="tab-logs">',
                '<p>',
                '<input data="LogEmailByDefault" id="logemailbydefault" type="checkbox" class="asm-checkbox" /> <label for="logemailbydefault">' + _("Check the log email checkbox by default") + '</label>',
                '<br />',
