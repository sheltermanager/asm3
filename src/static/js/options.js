    ...
    const options = {
        ...
        render_movements: function() {
            return [
                ...
                '<p><label for="defaulttriallength">' + _("Trial adoptions last for") + '</label>',
                ...
                '<input data="DefaultTrialLength" id="defaulttriallength" type="text" data-min="0" data-max="365" class="asm-textbox asm-halftextbox asm-numberbox" /> ' + _(" days.") + '</p>',
