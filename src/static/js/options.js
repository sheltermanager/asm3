    ...
    const options = {
        ...
        render_lostandfound: function() {
            return [
                ...
                '<table class="asm-left-table">',
                '<tr>',
                '<td><label for="findlostfoundanimalcols">' + _("Find lost/found animal columns") + '</label></td>',
                '<td>',
                '<select id="findlostfoundanimalcols" class="asm-bsmselect" data="LostFoundAnimalSearchColumns" multiple="multiple">',
                options.two_pair_options(controller.lostfoundanimalfindcolumns),
                '</select>',
                '</td>',
                '</tr>',
                '</table>',
