    ...
    const options = {
        ...
        render_tabs: function() {
            return [
                ...
                '<li><a href="#tab-logs">' + _("Logs") + '</a></li>',
        ...
        render_accounts: function() {
            ...
            return [
                '<div id="tab-accounts">',
                '<p>',
                options.cb({ id: "disableaccounts", data: "rc:DisableAccounts", label: _("Enable accounts functionality") }),
                options.cb({ id: "createdonations", data: "CreateDonationTrx", label: _("Creating payments and payments types creates matching accounts and transactions") }),
                options.cb({ id: "createcost", data: "CreateCostTrx", label: _("Creating cost and cost types creates matching accounts and transactions") }),
                options.cb({ id: "donationtrxoverride", data: "DonationTrxOverride", label: _("When receiving payments, allow the deposit account to be overridden") }),
                options.cb({ id: "donationquantities", data: "DonationQuantities", label: _("When receiving payments, allow a quantity and unit price to be set") }),
                options.cb({ id: "donationfees", data: "DonationFees", label: _("When receiving payments, allow a transaction fee to be set") }),
                '<input data="VATEnabled" id="vatenabled" type="checkbox" class="asm-checkbox" />',
                '<label for="vatenabled">' + _("When receiving payments, allow recording of sales tax") + '</label>',
                '<br />',
                options.cb({ id: "vatexclusive", data: "VATExclusive", label: _("When calculating sales tax, assume the payment amount is net and add it") }),
                options.cb({ id: "donationdateoverride", data: "DonationDateOverride", label: _("When receiving multiple payments, allow the due and received dates to be set") }),
        ...
        render_adding: function() {
            return [
                '<div id="tab-adding">',
                '<p>',
                options.cb({ id: "aashowbreed", data: "AddAnimalsShowBreed", label: _("Show the breed fields") }),
                options.cb({ id: "singlebreed", data: "UseSingleBreedField", label: _("Use a single breed field") }),
                '</p>',
                ...
                '</div>',
                '<p>',
                options.cb({ id: "aashowcoattype", data: "AddAnimalsShowCoatType", label: _("Show the coat type field") }),
                options.cb({ id: "aashowcolour", data: "AddAnimalsShowColour", label: _("Show the color field") }),
                options.cb({ id: "aashowfee", data: "AddAnimalsShowFee", label: _("Show the adoption fee field") }),
                options.cb({ id: "aashowlocation", data: "AddAnimalsShowLocation", label: _("Show the internal location field") }),
                options.cb({ id: "aashowlocationunit", data: "AddAnimalsShowLocationUnit", label: _("Show the location unit field") }),
                options.cb({ id: "aashowfosterer", data: "AddAnimalsShowFosterer", label: _("Allow a fosterer to be selected") }),
                options.cb({ id: "aashowcoordinator", data: "AddAnimalsShowCoordinator", label: _("Allow an adoption coordinator to be selected") }),
                options.cb({ id: "aashowacceptance", data: "AddAnimalsShowAcceptance", label: _("Show the litter ID field") }),
                options.cb({ id: "aashowsize", data: "AddAnimalsShowSize", label: _("Show the size field") }),
                options.cb({ id: "aashowweight", data: "AddAnimalsShowWeight", label: _("Show the weight field") }),
                options.cb({ id: "aashowneutered", data: "AddAnimalsShowNeutered", label: _("Show the altered fields") }),
                options.cb({ id: "aashowmicrochip", data: "AddAnimalsShowMicrochip", label: _("Show the microchip fields") }),
                options.cb({ id: "aashowtattoo", data: "AddAnimalsShowTattoo", label: _("Show the tattoo fields") }),
                options.cb({ id: "aashowentrycategory", data: "AddAnimalsShowEntryCategory", label: _("Show the entry category field") }),
                options.cb({ id: "aashowentrytype", data: "AddAnimalsShowEntryType", label: _("Show the entry type field") }),
                options.cb({ id: "aashowjurisdiction", data: "AddAnimalsShowJurisdiction", label: _("Show the jurisdiction field") }),
                options.cb({ id: "aashowpickup", data: "AddAnimalsShowPickup", label: _("Show the pickup fields") }),
                options.cb({ id: "aashowdatebroughtin", data: "AddAnimalsShowDateBroughtIn", label: _("Show the date brought in field") }),
                options.cb({ id: "aashowtimebroughtin", data: "AddAnimalsShowTimeBroughtIn", label: _("Show the time brought in field") }),
                options.cb({ id: "aashoworiginalowner", data: "AddAnimalsShowOriginalOwner", label: _("Show the original owner field") }),
                options.cb({ id: "aashowbroughtinby", data: "AddAnimalsShowBroughtInBy", label: _("Show the brought in by field") }),
                options.cb({ id: "aashowhold", data: "AddAnimalsShowHold", label: _("Show the hold fields") }),
                options.cb({ id: "warnsimilaranimal", data: "WarnSimilarAnimalName", label: _("Warn if the name of the new animal is similar to one entered recently") }),
                '</p>',
                '</div>'
            ].join("\n");
        },
        ...
        render_defaults: function() {
            ...
            const items = [
                ...
                ddrop("defaulttaxrate", _("Tax Rate"), "AFDefaultTaxRate", html.list_to_options(controller.taxrates, "ID", "TAXRATENAME")),
        ...
        render_onlineforms: function() {
            return [
                ...
                '<input data="OnlineFormSpamHoneyTrap" id="spamhoneytrap" class="asm-checkbox" type="checkbox" /> <label for="spamhoneytrap">' + _("Spambot protection: Invisible textbox") + '</label><br/>',
                ...
                '<input data="OnlineFormSpamFirstnameMixCase" id="spamfirstname" class="asm-checkbox" type="checkbox" /> <label for="spamfirstname">' + _("Spambot protection: Person name mixed case") + '</label><br/>',
        ...
        render_reminders: function() {
            return [
                ...
                '<tr>',
                '<td>',
                '<input data="EmailVaccinationFollowup" id="vaccinationfollowup" type="checkbox" class="asm-checkbox" />',
                '<label for="vaccinationfollowup">' + _("Send a reminder email to owners X days before a vaccination is due") + '</label>',
                '</td>',
                '<td>',
                '<input data="EmailVaccinationFollowupDays" id="vaccinationfollowupdays" data-min="0" data-max="365" class="asm-textbox asm-numberbox" />',
                '</td>',
                '<td>',
                '<select data="EmailVaccinationFollowupTemplate" class="asm-selectbox">',
                edit_header.template_list_options(controller.templates),
                '</select>',
                '</td>',
                '</tr>',
            ...
            return [
                ...
                tableform.render_tabs([
                    ...
                    { id: "tab-display", title: _("Display"), fields: [
                        ...
                        { id: "usstatecodes", json_field: "USStateCodes", label: _("When entering addresses, restrict states to valid US 2 letter state codes"), type: "check", hideif: function() { return asm.locale != "en" } }, // To do - check that this behaves as intended
