            ...
            return [
                ...
                tableform.render_tabs([
                    ...
                    { id: "tab-logs", title: _("Logs"), fields: [
                        ...
                        { id: "animalcommentschangelog", post_field: "AnimalCommentsChangeLog", label: _("When I change the comments on an animal, make a note of it in the log with this type"), type: "check", xmarkup: ' <select data="AnimalCommentsChangeLogType" id="animalcommentschangelogtype" class="asm-selectbox">' + html.list_to_options(controller.logtypes, "ID", "LOGTYPENAME") + '</select>' }, 
