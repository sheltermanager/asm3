    ...
    var options = {
        ...
        render_documents: function() {
            return [
                ...
                '<input data="IncludeIncompleteVaccDoc" id="includeincompletevacc" type="checkbox" class="asm-checkbox" /> <label for="includeincompletevacc">' + _("Include incomplete vaccination and test records when generating document templates") + '</label>',
                '<br />',
        ...
        render_movements: function() {
            return [
                ...
                '<input data="SecondDonationOnMove" id="seconddonation" class="asm-checkbox" type="checkbox" /> <label for="seconddonation">' + _("Allow entry of two payments on the Move menu screens") + '</label><br />',
        ...
        render_options: function() {
            return [
                ...
                '<input data="ShowWeightInLbs" id="showlbs" class="asm-checkbox" type="checkbox" /> <label for="showlbs">' + _("Show weight in lbs rather than kg") + '</label><br />',
