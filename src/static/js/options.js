    ...
    const options = {
        ...
        render_reminders: function() {
            return [
                ...
                '<label for="adopterfollowup">' + _("Send a followup email to new adopters after days") + '</label>',
                '</td>',
                '<td>',
                ...
                '<label for="clinicreminder">' + _("Send a reminder email to people with clinic appointments in days") + '</label>',
                '</td>',
                '<td>',
                ...
                '<label for="licencereminder">' + _("Send a reminder email to people with licenses expiring in days") + '</label>',
                '</td>',
                '<td>',
