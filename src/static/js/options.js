    ...
    const options = {
        ...
        render_defaults: function() {
            ...
            return [
                ...
                '<br />',
                '<input data="AnimalSearchResultsNewTab" id="animalsearchnewtab" type="checkbox" class="asm-checkbox" /> <label for="animalsearchnewtab">' + _("Open animal search results in a new tab") + '</label>',
                '<br />',
                '<input data="PersonSearchResultsNewTab" id="personsearchnewtab" type="checkbox" class="asm-checkbox" /> <label for="personsearchnewtab">' + _("Open owner search results in a new tab") + '</label>',
                '<br />',
