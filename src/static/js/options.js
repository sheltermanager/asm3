    ...
    const options = {
        ...
        render_checkout: function() {
            return [
                ...
                '</tr>',
                '<tr>',
                '<td><label for="AdoptionCheckoutDonationID">' + _("Optional donation payment type") + '</label></td>',
                '<td>',
                ...
                '</tr>',
                '<tr>',
                '<td><label for="AdoptionCheckoutDonationAmount">' + _("Optional donation suggested amount") + '</label></td>',
                '<td>',
                '<input id="AdoptionCheckoutDonationAmount" data="AdoptionCheckoutDonationAmount" class="asm-currencybox asm-textbox">',
                '</select>',
                '</td>',
                '</tr>',
                '</table>',
