    ...
    const options = {
        ...
        render_watermark: function() {
            return [
                ...
                '</tr>',
                '<tr>',
                '<td><label for="watermarkfontfile">' + _("Watermark font file") + '</label></td>',
                '<td><input data="WatermarkFontFile" id="watermarkfontfile" class="asm-doubletextbox" type="text" /></td>',
                '</tr>',
                '<tr>',
