...
$(function() {
    ...
    var dialog = {
        ...
        fields: [
            ...
            { json_field: "TOTAL", post_field: "total", label: _("Total"), type: "intnumber", 
                tooltip: _("Total number of units in the container") },
            { json_field: "BALANCE", post_field: "balance", label: _("Balance"), type: "intnumber", validation: "notblank",
