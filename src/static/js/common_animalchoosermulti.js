    ...
    $.widget("asm.animalchoosermulti", {
        ...
        _create: function() {
            var h = [
                ...
                '<button class="animalchoosermulti-link-find">' + _("Select animals") + '</button>',
                '<button class="animalchoosermulti-link-clear">' + _("Clear") + '</button>',
                '</td>',
                '</tr>',
                '</table>',
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    $.each(self.rows, function(i, a) {
                        results.append( '<div class="asm-animalchoosermulti-result">' + 
                            html.animal_link(a, { showselector: true, showunit: true, showlocation: true }) + 
