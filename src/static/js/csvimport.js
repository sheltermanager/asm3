    ...
    const csvimport = {
        ...
        render: function() {
            return [
                ...
                '</div>',
                '<p>',
                '<input id="entrytoday" name="entrytoday" type="checkbox" data-x="entrytodayexplain" /> ',
                '<label for="entrytoday">' + _("Set entry date to today") + '</label>',
                '</p>',
                '<div id="entrytodayexplain" style="display: none">',
                html.info(_("Animal records in the file will have their ANIMALENTRYDATE overridden to today. Useful if the animals are being transferred into your shelter.")),
                '</div>',
                '</td>',
                '</tr>',
                '<tr>',
