    ...
    var publish_options = {
        ...
        render_foundanimals: function() {
            return [
                ...
                '</tr>',
                '<tr>',
                '<td><label for="faemail">Account email</label></td>',
                ...
                'account email in this field. If you do not have an account, visit <a href="http://found.org/start">found.org/start</a><br/>',
                '</span>',
                '</td>',
                '</tr>',
                '</table>',
