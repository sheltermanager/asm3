            ...
            const dialog = {
                ...
                fields: [
                    ...
                    { json_field: "VIEWROLEIDS", post_field: "viewroles", label: _("View Roles"), type: "selectmulti",
                        options: { displayfield: "ROLENAME", valuefield: "ID", rows: controller.roles },
                        callout: _("Only allow users with one of these roles to view incoming forms of this type") },
