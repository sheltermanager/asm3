        ...
        render_details: function() {
            return [
                ...
                tableform.fields_render([
                    ...
                    { post_field: "hometelephone", json_field: "HOMETELEPHONE", type: "text", label: _("Home Phone"), 
                        classes: "asm-phone", rowclasses: "homeworkphone" },
                    { post_field: "worktelephone", json_field: "WORKTELEPHONE", type: "text", label: _("Work Phone"), 
                        classes: "asm-phone", rowclasses: "homeworkphone", colclasses: "nowrap",
                        xmarkup: tableform.render_text({ justwidget: true, post_field: "worktelephone2", json_field: "WORKTELEPHONE2", classes: "tag-couple asm-phone" }) },
                    { post_field: "mobiletelephone", json_field: "MOBILETELEPHONE", type: "text", label: _("Cell Phone"),  
                        classes: "asm-phone", colclasses: "nowrap",
                        xmarkup: tableform.render_text({ justwidget: true, post_field: "mobiletelephone2", json_field: "MOBILETELEPHONE2", classes: "tag-couple asm-phone" }) },
