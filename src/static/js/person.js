        ...
        render_details: function() {
            return [
                ...
                tableform.fields_render([
                    ...
                    { post_field: "hometelephone", json_field: "HOMETELEPHONE", type: "text", label: _("Home Phone"), rowclasses: "homeworkphone" },
                    { post_field: "worktelephone", json_field: "WORKTELEPHONE", type: "text", label: _("Work Phone"), rowclasses: "homeworkphone", colclasses: "nowrap",
                        xmarkup: tableform.render_text({ justwidget: true, post_field: "worktelephone2", json_field: "WORKTELEPHONE2", classes: "tag-couple" }) },
                    { post_field: "mobiletelephone", json_field: "MOBILETELEPHONE", type: "text", label: _("Cell Phone"),  colclasses: "nowrap",
