    ...
    const reports_querybuilder = {
        ...
        render: function() {
            return [
                ...
                '</td>',
                '<td class="bottomborder">',
                '<select id="qbfields" data="qbfields" multiple="multiple" class="qb asm-selectmulti">',
                '</select>',
                '</td>',
                '</tr><tr>',
                '<td class="bottomborder">',
                ...
                '</td>',
                '<td class="bottomborder">',
                '<select id="qbcriteria" data="qbcriteria" multiple="multiple" class="qb asm-selectmulti">',
                '</select>',
                '</td>',
                '</tr><tr>',
                '<td class="bottomborder">',
                ...
                '</td>',
                '<td class="bottomborder">',
                '<select id="qbsort" data="qbsort" multiple="multiple" class="qb asm-selectmulti">',
                '</select>',
                '</td>',
                '</tr><tr>',
                '<td>',
