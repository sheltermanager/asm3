...
const mobile = {
    ...
    ajax_post: function(formdata, successfunc, errorfunc) {
        $.ajax({
            ...
            error: function(jqxhr, textstatus, response) {
                ...
                mobile.show_error(textstatus, common.get_error_response(jqxhr, textstatus, response));
            }
        });
    },
    ...
    render: function() {
        return [
            ...
            '<div id="content-checkmicrochip" class="container" style="display: none">',
                '<h2 class="mt-3">' + _("Check Microchip") + '</h2>',
                '<div class="mb-3">',
                    '<label for="microchipnumbersearch" class="form-label">' + _("Microchip Number") + '</label>',
                    '<input type="text" class="form-control" id="microchipnumbersearch">',
                '</div>',
                '<button id="btn-check-microchip" type="button" class="btn btn-primary">' + _("Check"),
                    '<div class="spinner-border spinner-border-sm" style="display: none"></div>',
                '</button>',
            '</div>',

            '<div id="content-dailyobs" class="container" style="display: none">',
                '<h2 class="mt-3">' + _("Daily Observations") + '</h2>',
                '<div class="mb-3">',
                    '<select class="form-select" id="dailyobslocation">',
                    html.list_to_options(controller.internallocations, "ID", "LOCATIONNAME"),
                    '</select>',
                '</div>',
                '<div class="list-group"></div>',
                '<div class="mt-3">',
                    '<button id="btn-commit-dailyobs" type="button" class="btn btn-primary">' + _("Commit"),
                        '<div class="spinner-border spinner-border-sm" style="display: none"></div>',
                    '</button>',
                    '<button id="btn-clear-dailyobs" type="button" class="btn btn-secondary">' + _("Clear"),
                        '<div class="spinner-border spinner-border-sm" style="display: none"></div>',
                    '</button>',
                '</div>',
            '</div>',
            ...
            '<div id="content-microchipresults" class="container" style="display: none">',
            '<h2 class="mt-3">' + _("Check Microchip") + '</h2>',
            '<div class="mb-3">',
            '<a href="#" data-link="checkmicrochip" class="list-group-item list-group-item-action internal-link">',
            '&#8592; ' + _("Back") + '</a>',
            '</div>',
            '<div class="list-group">',
            '</div>',
                    ...
                    '<li class="nav-item dropdown">',
                        ...
                        '<div class="dropdown-menu shadow-sm" aria-labelledby="dropdown-animals">',
                            '<a class="dropdown-item internal-link" data-perm="aa" data-link="addanimal" href="#">',
                                ...
                                _("Add Animal"),
                            '</a>',
                            '<a class="dropdown-item internal-link" data-perm="aa" data-link="dailyobs" href="#">',
                                '<span class="asm-icon asm-icon-forms"></span>',
                                _("Daily Observations"),
                            '</a>',
                            ...
                            '</a>',
                            '<a class="dropdown-item internal-link" data-perm="vapl" data-link="checkmicrochip" href="#">',
                                '<span class="asm-icon asm-icon-microchip"></span>',
                                _("Check Microchip"),
                            '</a>',
