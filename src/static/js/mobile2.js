    ...
    const mobile = {
        ...
        render: function() {
            return [
                ...
                '<form method="post" action="' + mobile.post_handler + '">',
                ...
                '<div class="mb-3">',
                    ...
                    '<input type="text" class="form-control" id="estimatedage" name="estimatedage" value="1.0">',
                '</div>',
                '<div class="mb-3">',
        ...
        sync: function() {
            ...
            // If an animalid is present in the URL, load it
            if (common.querystring_param("animalid")) {
                let animalid = common.querystring_param("animalid"), a = null;
                $.each(controller.animals, function(i, v) {
                    if (v.ID == animalid) { a = v; return false; }
                });
                if (a) { 
