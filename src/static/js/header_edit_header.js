...
edit_header = {
    ...
    animal_edit_header: function(a, selected, counts) {
        ...
        var tabs = [[ "animal", "animal", _("Animal"), "", "va" ],
            ...
            [ "conditions", "animal_condition", _("Conditions"), "condition", "vaco" ],
    ...
    lostfound_edit_header: function(mode, a, selected, counts) {
        ...
        var h = [
            ...
            '<table><tr>',
            '<td>',
            '<a href="' + html.img_src(a, prefix) + '">',
            '<img class="' + html.animal_link_thumb_classes(a) + '" src="' + html.thumbnail_src(a, prefix + "thumb") + '" />',
            '</a>',
            '</td>',
            '<td>',
    ...
    waitinglist_edit_header: function(a, selected, counts) {
        ...
        var h = [
            ...
            '<table><tr>',
            '<td>',
            '<a href="' + html.img_src(a, "waitinglist") + '">',
            '<img class="' + html.animal_link_thumb_classes(a) + '" src="' + html.thumbnail_src(a, "waitinglistthumb") + '" />',
            '</a>',
            '</td>',
            '<td>',
