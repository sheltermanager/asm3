    ...
    const roles = {
        ...
        render_dialog: function() {
            ...
            return [
                ...
                cr("car", _("Change Animal Role Permissions")),
                ...
                cl(_("Conditions")),
                cr("aaco", _("Add Conditions")),
                cr("vaco", _("View Conditions")),
                cr("caco", _("Change Conditions")),
                cr("daco", _("Delete Conditions")),
                cl(_("Diets")),
                cr("daad", _("Add Diets")),
                ...
                cr("cor", _("Change Person Role Permissions")),
                ...
                cr("cior", _("Change Investigation Role Permissions")),
