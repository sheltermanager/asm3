    ...
    var incident = {
        ...
        render_dispatch: function() {
            return [
                ...
                '<input id="followuptime" data-json="FOLLOWUPDATETIME" data-post="followuptime" class="asm-halftextbox asm-timebox" /></span></td>',
                '</tr>',
                '<tr>',
                ...
                '<input id="followuptime2" data-json="FOLLOWUPDATETIME2" data-post="followuptime2" class="asm-halftextbox asm-timebox" /></span></td>',
                '</tr>',
                '<tr>',
                ...
                '<input id="followuptime3" data-json="FOLLOWUPDATETIME3" data-post="followuptime3" class="asm-halftextbox asm-timebox" /></span></td>',
                '</tr>',
                '</table>',
