...
matched_route.run();return true;}else{if(Path.routes.rescue!==null){Path.routes.rescue(passed_route);}}}},'listen':function(){var fn=function(){Path.dispatch(location.hash);}
