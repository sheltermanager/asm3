...
For methods that require authentication. You may either provide a username and
password for a valid ASM user using the "username" and "password" parameters.
We recommend that user accounts used to make service API calls have "can login"
set to NO.

Eg:

    http://localhost:5000/service?method=json_adoptable_animals&username=user&password=letmein

Alternatively you may provide an API key that is allowed to call the method, generated in 
:menuselection:`Publishing -> Set Publishing Options -> API Keys` using the "key" parameter.

Eg:
    
  http://localhost:5000/service?method=json_adoptable_animals&key=4d171e79-8c69-4a9d-a5f1-8e6152c16e98
...
.. rubric:: Requires authentication: NO
...
.. rubric:: Requires authentication: YES
...
json_microchip_registrations, xml_microchip_registrations, csv_microchip_registrations
--------------------------------------------------------------------------------------
...
Returns a dataset containing animals that have an event that requires microchip
registration in the last 30 days. This call can be used by microchip registries
to keep their databases upto date.

Parameters can be passed for "days" (how far back to go) and "prefix" to only
return animals with microchips that have a particular prefix. 
...
A sample microchip dataset looks like this::
    ...
    [
       {
           "ID": 12345,
           "SHELTERCODE": "D2021345",
           "ANIMALNAME": "Rover",
           "SPECIESNAME": "Dog",
           "BREEDNAME": "Labrador Retriever",
           "BASECOLOUR": "Black",
           "SIZE": "Large",
           "DATEOFBIRTH": "2010-01-20T00:00:00",
           "NONSHELTERANIMAL": 0,
           "ARCHIVED": 1,
           "MOSTRECENTENTRYDATE": "2025-12-12T00:00:00",
           "ACTIVEMOVEMENTID": 2983,
           "ACTIVEMOVEMENTTYPE": 1,
           "ACTIVEMOVEMENTTYPENAME": "Adoption",
           "ACTIVEMOVEMENTDATE": "2026-01-08T00:00:00",
           ...
           "CURRENTOWNERFORENAMES": "Test",
           "CURRENTOWNERSURNAME": "Testing",
           "CURRENTOWNERADDRESS": "123 Test Street",
           "CURRENTOWNERTOWN": "Testville",
           "CURRENTOWNERCOUNTY": "TS",
           "CURRENTOWNERPOSTCODE": "12345",
           "CURRENTOWNERCOUNTRY": "USA",
           "CURRENTOWNERHOMETELEPHONE": "(123) 123-1234",
           "CURRENTOWNERWORKTELEPHONE": "",
           "CURRENTOWNERMOBILETELEPHONE": "(123) 123-1234",
           "CURRENTOWNEREMAILADDRESS": "test@test.com",
           "CURRENTOWNEREMAILADDRESS2": "test@test.com",
           "CURRENTOWNERIDNUMBER": "098232",
...
The dataset conforms to the shelteranimalscount.org data 
specification and species should be one of:
    
    canine, feline, rabbit, equine, small_mammal, farm_animal, bird, reptile_or_amphibian

The method determines whether the format returned is JSON, CSV or XML::

    http://localhost:5000/service?method=csv_montly_stats&username=user&password=letmein&month=1&year=2026&species=feline
