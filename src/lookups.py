...
LOOKUP_TABLES = {
    ...
    "reservationstatus": (_("Reservation Statuses"), "StatusName", _("Status"), "StatusDescription", 0, 0, 0, 0, 0, 1, 1, ("adoption.ReservationStatusID",)),
...
MICROCHIP_MANUFACTURERS = [
    { "length": 16, "regex": r"^AVID", "name": "AVID" },
    { "length": 14, "regex": r"^TR", "name": "AKC Reunite" },
    { "length": 9,  "regex": r"^\d+$", "name": "AVID" },
    { "length": 11, "regex": r"^\d{3}\*\d{3}\*\d{3}", "name": "AVID" },
    { "length": 11, "regex": r"^\d{3}\-\d{3}\-\d{3}", "name": "AVID" },
    { "length": 10, "regex": r"^0A1", "name": "24PetWatch" },
    { "length": 10, "regex": r"0D", "name": "Banfield" },
    { "length": 10, "regex": r"^0A0", "name": "Microchip ID" },
    { "length": 10, "regex": r"^0006", "name": "AKC Reunite" },
    { "length": 10, "regex": r"^0007", "name": "AKC Reunite" },
    { "length": 10, "regex": r"^0C0", "name": "M4S ID" },
    { "length": 10, "regex": r"^1\d+A", "name": "AVID Europe" }, 
    { "length": 15, "regex": r"^360981", "name": "Novartis" },
    { "length": 15, "regex": r"^578098", "name": "Kruuse Norge" },
    { "length": 15, "regex": r"^90007400", "name": "SmartTag" },
    { "length": 15, "regex": r"^900008", "name": "Orthana Intertrade" },
    { "length": 15, "regex": r"^900023", "name": "Asian Information Technology" },
    { "length": 15, "regex": r"^900026", "name": "Petsafe" },
    { "length": 15, "regex": r"^900042", "name": "Royal Tag" },
    { "length": 15, "regex": r"^900088", "name": "Insprovet" },
    { "length": 15, "regex": r"^900118", "name": "SmartChip" },
    { "length": 15, "regex": r"^900128", "name": "Gepe-Geimuplast" },
    { "length": 15, "regex": r"^900138", "name": "ID-Ology" },
    { "length": 15, "regex": r"^900164", "name": "Save This Life" },
    { "length": 15, "regex": r"^900182", "name": "Petlog" },
    { "length": 15, "regex": r"^900", "name": "BCDS" },
    { "length": 15, "regex": r"^939", "name": "M4S ID" },
    { "length": 15, "regex": r"^941", "name": "Felixcan" },
    { "length": 15, "regex": r"^943", "name": "BCDS" },
    { "length": 15, "regex": r"^945", "name": "BCDS" },
    { "length": 15, "regex": r"^952", "name": "M4S ID" },
    { "length": 15, "regex": r"^95301", "name": "Australasian Animal Registry" },
    { "length": 15, "regex": r"^955", "name": "Biolog-ID" },
    { "length": 15, "regex": r"^956", "name": "AKC Reunite" },
    { "length": 15, "regex": r"^965", "name": "4D Technology/Petsafe" },
    { "length": 15, "regex": r"^960011", "name": "PetProtect" },
    { "length": 15, "regex": r"^965", "name": "Microchip ID" },
    { "length": 15, "regex": r"^966", "name": "Petlog" },
    { "length": 15, "regex": r"^968", "name": "AKC CAR" },
    { "length": 15, "regex": r"^972", "name": "Planet ID" },
    { "length": 15, "regex": r"^977", "name": "AVID Europe" },
    { "length": 15, "regex": r"^978", "name": "Chevillot/Back Home" },
    { "length": 15, "regex": r"^980000", "name": "Agrident" },
    { "length": 15, "regex": r"^98101", "name": "DataMARS/Banfield" },
    { "length": 15, "regex": r"^98102", "name": "DataMARS/PetLink" },
    { "length": 15, "regex": r"^981", "name": "DataMARS/Bayer ResQ" },
    { "length": 15, "regex": r"^982009", "name": "Allflex" },
    { "length": 15, "regex": r"^982", "name": "24PetWatch" },
    { "length": 15, "regex": r"^984", "name": "Nedap" },
    { "length": 15, "regex": r"^9851", "name": "Anibase/Identichip" },
    { "length": 15, "regex": r"^985", "name": "HomeAgain" },
    { "length": 15, "regex": r"^9861", "name": "Anibase/Identichip" },
    { "length": 15, "regex": r"^999", "name": "Transponder Test" }
]
