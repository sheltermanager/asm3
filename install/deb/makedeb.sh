...
Architecture: all
Essential: no
Depends: debconf, memcached, libapache2-mod-wsgi-py3, python3-cheroot, python3-pil, python3-memcache, python3-requests, python3-mysqldb, python3-psycopg2, python3-reportlab, python3-xhtml2pdf, python3-lxml, weasyprint, python3-qrcode
Suggests: mysql-server, imagemagick, python3-stripe, python3-boto, python3-openpyxl, python3-kombu
