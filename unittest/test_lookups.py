...
class TestLookups(unittest.TestCase):
    ...
    def test_get(self):
        ...
        assert len(asm3.lookups.get_additionalfield_links(base.get_dbo())) > 0
        assert len(asm3.lookups.get_additionalfield_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_animal_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_basecolours(base.get_dbo()) )> 0
        assert len(asm3.lookups.get_breeds(base.get_dbo())) > 0
        assert len(asm3.lookups.get_breeds_by_species(base.get_dbo())) > 0
        assert len(asm3.lookups.get_citation_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_coattypes(base.get_dbo())) > 0
        assert len(asm3.lookups.get_costtypes(base.get_dbo())) > 0
        assert len(asm3.lookups.get_deathreasons(base.get_dbo())) > 0
        assert len(asm3.lookups.get_diets(base.get_dbo())) > 0
        assert len(asm3.lookups.get_donation_frequencies(base.get_dbo())) > 0
        assert len(asm3.lookups.get_donation_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_entryreasons(base.get_dbo())) > 0
        assert len(asm3.lookups.get_incident_completed_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_incident_types(base.get_dbo())) > 0
        assert len(asm3.lookups.get_internal_locations(base.get_dbo())) > 0
        ...
        assert len(asm3.lookups.get_sizes(base.get_dbo())) > 0
        assert len(asm3.lookups.get_trap_types(base.get_dbo())) > 0
        ...
        assert len(asm3.lookups.get_ynun(base.get_dbo())) > 0
