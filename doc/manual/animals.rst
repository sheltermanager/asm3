...
outstanding treatments from here. Each treatment shows both the date and
optionally, the time it is due and given. For regimens with more than one
treatment per day, you can configure the default treatment times when creating
or editing the regimen and then override individual times in the medical book
if required.
