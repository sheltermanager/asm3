...
reader = csv.reader(open(PATH + "list1.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "animalhistory.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "record.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "euthanasia.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "adopts.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "appeals.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "payments.csv", "r"), dialect="excel")
for row in reader:
...
reader = csv.reader(open(PATH + "complaints.csv", "r"), dialect="excel")
for row in reader:
